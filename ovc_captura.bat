...
echo   Puerto proxy: 8080
echo ================================================================
echo.
echo INSTRUCCIONES:
echo  1. Esta ventana va a abrir el proxy en 127.0.0.1:8080
echo  2. Configura Chrome: Ajustes ^> Proxy ^> 127.0.0.1:8080
...
echo [INFO] Iniciando proxy mitmproxy en 127.0.0.1:8080...
